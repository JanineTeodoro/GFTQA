...
public class Main{
    ...
    //Deixei essa classe static para sair o erro do primeiro add. Qualquer coisa mudar novamente.
    static class Serie implements Comparable <Serie>{
        private String nome;
        private String genero;
        private Integer tempoEpisodio;

        Serie(String nome, String genero, Integer tempoEpisodio) {
            this.nome = nome;
            this.genero = genero;
    ...
    //Deixei essa classe static para sair o erro do segundo TreeSet. Qualquer coisa mudar novamente.
